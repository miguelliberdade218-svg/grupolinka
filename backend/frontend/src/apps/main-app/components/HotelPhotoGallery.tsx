 ...
 */
const GridMode: React.FC<HotelPhotoGalleryProps> = ({
  photos,
  onPhotoSelect,
  className,
}) => {
 ...
 */
const PreviewMode: React.FC<HotelPhotoGalleryProps> = ({
  photos,
  title,
  onPhotoSelect,
  className,
 ...
 */
const FullMode: React.FC<HotelPhotoGalleryProps> = ({
  photos,
  title,
  className,
}) => {
 ...
 */
export const HotelPhotoGallery: React.FC<HotelPhotoGalleryProps> = ({
  photos,
  mode = 'preview',
  ...props
}) => {
