...
// ✅ CORREÇÃO: Interface MatchStats atualizada COMPLETA
...
export default function RideSearchPage() {
  ...
  const [searchParams, setSearchParams] = useState<RideSearchParamsExtended>({
    ...
    date: "",
    passengers: 1,
    radius: 100 // ✅ CORREÇÃO: Raio padrão de 100km (como funcionava antes)
  });
        ...
        <Card className="mb-4">
          <CardContent className="pt-4">
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-3">
              ...
              <div className="flex items-center gap-2 bg-indigo-50 text-indigo-700 px-3 py-1 rounded-lg border border-indigo-200 text-xs">
                <Navigation className="w-3 h-3" />
                <div>
                  <p className="font-medium">Busca Inteligente Final</p>
                  <p>Raio: {searchParams.radius || 200}km • Função: get_rides_smart_final</p>
                </div>
              </div>
            </div>
          </CardContent>
                  ...
                  <div className="bg-orange-50 border border-orange-200 rounded-lg p-3">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-orange-600">Alta Pontuação</div>
                      </div>
                      <div className="text-center">
